...
=head3 Natural logarithm of gamma function
...
=head3 Complementary error function
...
=head3 Normal distribution function
...
=head3 Inverse of the error function
...
=head3 Inverse of Normal distribution function
...
=head3 Incomplete gamma integral
...
=head3 Complemented incomplete gamma integral
...
=head3 Inverse of complemented imcomplete gamma integral
...
=head3 Bessel function of order zero
...
=head3 Bessel function of order one
...
=head3 Bessel function of integer order
...
=head3 Bessel function of the second kind, order zero
...
=head3 Bessel function of second kind of order one
...
=head3 Bessel function of second kind of integer order
...
=head3 Modified Bessel function of order zero
...
=head3 Modified Bessel function of order one
...
=head3 Modified Bessel function, second kind, order zero
...
=head3 Modified Bessel function, second kind, order one
...
=head3 Modified Bessel function, second kind, integer order
...
=head3 Incomplete beta integral
...
=head3 Inverse of imcomplete beta integral
...
=head3 Complemented binomial distribution
...
=head3 Inverse binomial distribution
...
=head3 Calculation of the value of the Chebyshev polynomials of the
...
=head3 Summation of Chebyshev polynomials using Clenshawís recurrence formula.
...
=head3 Representation of Tn as C[0] + C[1]*X + ... + C[N]*X^N
...
=head3 Conversion of a series of Chebyshev polynomials to a power series.
...
=head3 Complemented Chi-square distribution
...
=head3 Inverse of complemented Chi-square distribution
...
=head3 Complete elliptic integral of the first kind
...
=head3 Incomplete elliptic integral of the first kind F(phi|m)
...
=head3 Complete elliptic integral of the second kind
...
=head3 Incomplete elliptic integral of the second kind
...
=head3 Exponential integral Ei(x)
...
=head3 Exponential integral En(x)
...
=head3 Complemented F distribution
...
=head3 Inverse of complemented F distribution
...
=head3 Calculation of the value of the Hermite polynomial.
...
=head3 Summation of Hermite polynomials using Clenshawís recurrence formula.
...
=head3 Representation of Hn as C[0] + C[1]*X + ... + C[N]*X^N
...
=head3 Jacobian Elliptic Functions
...
=head3 Calculation of the value of the Laguerre polynomial.
...
=head3 Summation of Laguerre polynomials using Clenshawís recurrence formula.
...
=head3 Representation of Ln as C[0] + C[1]*X + ... + C[N]*X^N
...
=head3 Calculation of the value of the Legendre polynomial Pn.
...
=head3 Summation of Legendre polynomials using Clenshawís recurrence formula.
...
=head3 Representation of Pn as C[0] + C[1]*X + ... + C[N]*X^N
...
=head3 Complemented Poisson distribution
...
=head3 Inverse Poisson distribution
...
=head3 Student's t distribution
...
=head3 Functional inverse of Student's t distribution
...
=head3 Sine and cosine integrals
...
=head3 Hyperbolic sine and cosine integrals
