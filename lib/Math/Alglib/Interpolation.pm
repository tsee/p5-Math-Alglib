...
=head2 IDW interpolant using modified Shepard method for uniform point
...
=head2 IDW interpolant using modified Shepard method for non-uniform datasets.
...
=head2 IDW model for noisy data.
...
=head2 Rational interpolation using barycentric formula
...
=head2 Differentiation of barycentric interpolant: first derivative.
...
=head2 Differentiation of barycentric interpolant: first/second derivatives.
...
=head2 This subroutine performs linear transformation of the argument.
...
=head2 This  subroutine   performs   linear  transformation  of  the  barycentric
...
=head2 Extracts X/Y/W arrays from rational interpolant
...
=head2 Rational interpolant from X/Y/W arrays
...
=head2 Rational interpolant without poles
...
=head2 Conversion from barycentric representation to Chebyshev basis.
...
=head2 Conversion from Chebyshev basis to barycentric representation.
...
=head2 Lagrange intepolant: generation of the model on the general grid.
...
=head2 Lagrange intepolant: generation of the model on equidistant grid.
...
=head2 Lagrange intepolant on Chebyshev grid (first kind).
...
=head2 Lagrange intepolant on Chebyshev grid (second kind).
...
=head2 Fast equidistant polynomial interpolation function with O(N) complexity
...
=head2 Fast polynomial interpolation function on Chebyshev points (first kind)
...
=head2 Fast polynomial interpolation function on Chebyshev points (second kind)
...
=head2 This subroutine builds linear spline interpolant
...
=head2 This subroutine builds Hermite spline interpolant.
...
=head2 This subroutine builds Akima spline interpolant
...
=head2 This subroutine calculates the value of the spline at the given point X.
...
=head2 This subroutine differentiates the spline.
...
=head2 This subroutine unpacks the spline into the coefficients table.
...
=head2 This subroutine performs linear transformation of the spline argument.
...
=head2 This subroutine performs linear transformation of the spline.
...
=head2 This subroutine integrates the spline.
...
=head2 This function builds monotone cubic Hermite interpolant. This interpolant
...
Returns array ref of three elements: info, barycentricinterpolant object, hashref of polynomialfitreport data
...
=head2 Weighted  fitting by polynomials in barycentric form, with constraints  on
...
Note on the Perl wrapper:
Returns array ref of three elements: info, barycentricinterpolant object, hashref of barycentricfitreport data
...
=head2 Weighted fitting by penalized cubic spline.
...
=head2 Weighted fitting by cubic  spline,  with constraints on function values or
...
=head2 Weighted  fitting  by Hermite spline,  with constraints on function values
...
=head2 Least squares fitting by cubic spline.
...
=head2 Least squares fitting by Hermite spline.
...
=head2 Weighted linear least squares fitting.

Note on the Perl wrapper:
Returns array ref of three elements: info, array ref of decomposition coefficients, hashref of lsfitreport data
...
=head2 Weighted constained linear least squares fitting.
...
=head2 Linear least squares fitting.
...
=head2 Constained linear least squares fitting.
...
=head2 This function  builds  non-periodic 3-dimensional parametric spline  which
...
=head2 This  function  builds  periodic  2-dimensional  parametric  spline  which
...
=head2 This  function  builds  periodic  3-dimensional  parametric  spline  which
...
=head2 This function returns vector of parameter values correspoding to points.

Note on the Perl wrapper:
Returns array ref of two elements: n, t
...
=head2 This function  calculates  the value of the parametric spline for a  given

Note on the Perl wrapper:
Also aliased to not include the "pspline\d" method name prefix.
...
=head2 This function  calculates  tangent vector for a given value of parameter T
...
=head2 This function calculates derivative, i.e. it returns (dX/dT,dY/dT).
...
=head2 This function calculates derivative, i.e. it returns (dX/dT,dY/dT,dZ/dT).
...
=head2 This function calculates first and second derivative with respect to T.
...
=head2 This function  calculates  arc length, i.e. length of  curve  between  t=a
...
=head2 This function unserializes data structure from string.

  void rbfunserialize(std::string &s_in, rbfmodel &obj);


=head2 This function creates RBF  model  for  a  scalar (NY=1)  or  vector (NY>1)
...
=head2 This function adds dataset.
...
=head2 This function sets linear term (model is a sum of radial  basis  functions
...
=head2 This function sets constant term (model is a sum of radial basis functions
...
=head2 This  function  sets  zero  term (model is a sum of radial basis functions
...
=head2 This function calculates values of the RBF model in the given point.
...
=head2 This function calculates values of the RBF model at the given point.
...
=head2 This function calculates values of the RBF model at the regular grid.
...
=head2 This function "unpacks" RBF model by extracting its coefficients.
...
=head2 This subroutine calculates the value of the bilinear or bicubic spline  at
...
=head2 Bilinear spline resampling
...
=head2 This subroutine builds bilinear vector-valued spline.
...
=head2 This subroutine builds bicubic vector-valued spline.
...
=head2 This subroutine calculates bilinear or bicubic vector-valued spline at the
...
=head2 This subroutine unpacks two-dimensional spline into the coefficients table
...
=head2 This subroutine was deprecated in ALGLIB 3.6.0
...
=head2 This subroutine calculates the value of the trilinear or tricubic spline at
...
=head2 Trilinear spline resampling
...
=head2 This subroutine builds trilinear vector-valued spline.
...
=head2 This subroutine calculates trilinear or tricubic vector-valued spline at the
...
=head2 This subroutine unpacks tri-dimensional spline into the coefficients table
